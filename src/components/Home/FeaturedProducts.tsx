  ...
  return (
    <section className="bg-[#f1f9f7] py-14 px-4 md:px-12">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center text-3xl font-bold mb-12 text-primary">Featured Products</h2>
          ...
          {featuredProducts.map((product) => {
            ...
            return (
              <Link href={`/shop/${product._id}`} passHref key={product._id}>
                <div className="bg-white rounded-xl p-4 flex items-center gap-4 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer">
                  <Image
